...
class _PageProfilAmiState extends State<PageProfilAmi> {
  ...
  IconData _iconR = Icons.favorite_outline;
          ...
          children: [
            Container(
              ...
              child: Column(
                children: [
                  FutureBuilder<Users>(
                    future: AuthController.getUserById(widget.user.id),
                    builder:
                              ...
                              children: [
                                ListTile(
                                  ...
                                  trailing: ElevatedButton(
                                    onPressed: () {
                                      if (_iconR == Icons.favorite_outline) {
                                        AuthController.postFavoris(
                                            id, snapshot.data![index].id);
                                        setState(() {
                                          _iconR = Icons.favorite;
                                        });
                                      } else {
                                        if (_iconR == Icons.favorite) {
                                          AuthController.deleteFavoris(
                                              widget.user.id,
                                              snapshot.data![index].id);
                                          setState(() {
                                            _iconR = Icons.favorite_outline;
                                          });
                                        }
                                      }
                                    },
